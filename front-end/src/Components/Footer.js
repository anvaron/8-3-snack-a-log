      ...
      <div class="flex flex-col">
          ...
          <div class="mt-4 md:mt-0 flex flex-col md:flex-row">
              ...
              <div class="mt-4 md:mt-0 flex-1 flex items-center justify-center md:border-r border-gray-100">
                  <a class="hover:text-primary-gray-20" href="https://github.com/ecod24/8-3-snack-a-log">
                      <span class="sr-only">
                          View on GitHub
                      </span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="text-xl hover:text-gray-800 dark:hover:text-white transition-colors duration-200" viewBox="0 0 1792 1792">
              ...
              <div class="mt-7 md:mt-0 flex-1 flex flex-col items-center justify-center md:items-start md:pl-5">
                  ...
                  <span class="mt-7 md:mt-1">
                      Created by
                      <a class="text-blue-800 hover:text-primary-gray-20 font-semibold ml-1" href="https://www.linkedin.com/in/crabiller/">
