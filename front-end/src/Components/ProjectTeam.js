...
export default function ProjectTeam() {
  return (
    <div className="box p-4 bg-blue-100">
        ...
        <div className="items-center justify-center h-screen flex items-center space-y-24 md:space-y-0 pt-64 md:pt-10 lg:pt-10 flex-col md:flex-row justify evenly">
