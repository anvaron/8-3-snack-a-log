      ...
      <div className="flex items-center justify-center h-screen ">
        <div className="block p-10 bg-white w-full md:w-6/12 mb-64 md:md-0 rounded-lg shadow-lg lg:p-12 lg:col-span-3 ">
          ...
          <div className="mt-6 mb-6">
            <label className="mb-2 text-xl font-bold text-gray-600" htmlFor="name">Name:</label>
            <input
              id="name"
              type="text"
              value={snack.name}
            ...
            <div className="mt-6 mb-6">
            <label className="mb-2 text-xl font-bold text-gray-600" htmlFor="image">Image: </label>
            <input
              id="image"
              type="text"
              value={snack.image}
            ...
            <div className="mt-6 mb-6">
            <label className="mb-2 text-xl font-bold text-gray-600" htmlFor="fiber">Fiber:</label>
            <input
              id="fiber"
              type="number"
              value={snack.fiber}
            ...
            <div className="mt-6 mb-6">
            <label className="mb-2 text-xl font-bold text-gray-600" htmlFor="protein">Protein:</label>
            <input
              id="protein"
              type="number"
              value={snack.protein}
            ...
            <div className="mt-6 mb-6">
            <label className="mb-2 text-xl font-bold text-gray-600" htmlFor="added_sugar">Added Sugar:</label>
            <input
              id="added_sugar"
              type="number"
            ...
            <div className="mt-6 mb-6">
            <label className="mb-2 text-xl font-bold text-gray-600" htmlFor="is_healthy">Healthy:</label>
            <input
              id="is_healthy"
              type="checkbox"
