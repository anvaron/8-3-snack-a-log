...
<div class="box p-4 bg-blue-100">
    ...
    <div class="items-center justify-center h-screen flex items-center space-y-24 md:space-y-0 flex-col md:flex-row justify evenly">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow px-8 py-4 pt-24">
                <div class="text-center">
                    ...
                    <p class="text-md text-gray-500 w-60 dark:text-gray-400 mx-auto py-4 font-light">
                      Full stack software engineer with extremely passion for working with cars and computers.
                    </p>
                </div>
        ...
        <div class="p-4 relative">
            <div class="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2">
                <a href="#" class="block relative">
                    <img alt="profil" src="https://avatars.githubusercontent.com/u/5624459?v=4" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"/>
                </a>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow px-8 py-4 pt-24">
                <div class="text-center">
                    ...
                    <p class="text-md text-gray-500 w-60 dark:text-gray-400 mx-auto py-4 font-light">
                    Full stack software engineer always anxious for solving problems by innovative solutions.
                    </p>
                </div>
                <div class="pt-8 flex border-t border-gray-200 w-40 mx-auto text-gray-500 items-center justify-between">
